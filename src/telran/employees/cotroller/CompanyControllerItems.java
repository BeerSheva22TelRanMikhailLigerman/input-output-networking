...
public class CompanyControllerItems {
	...
	private static Item[] getItems() {
		return new Item[] { getAdminMenu(), getUserMenu() };
	}
	...
	private static Item getUserMenu() {
		return new Menu("User actions", of("Display Employee Data", CompanyControllerItems::getEmployee),
				...
				of("Display Employess from Department", CompanyControllerItems::getEmployeesByDepartment), exit());
	}
	...
	private static Item getAdminMenu() {
		return new Menu("Admin actions", of("add employee", CompanyControllerItems::addEmployee),
										...
										of("Update Department", CompanyControllerItems::updateDepartment),
										exit());
	}
	...
	private static void updateDepartment(InputOutput io) {
		...
		if (id == null) {
			...
			String newDepartment = getDepartment(io);
